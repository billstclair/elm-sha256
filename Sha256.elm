  ...
  in
      let s0 = (d ~>>> 2) ~| (d ~>>> 30)
          s1 =  ((h ~>>> 6) ~| (h ~<< 26))
             ...
             ~^ ((h ~>>> 25) ~| (h ~<< 7))
          da = d ~& a
      in let maj = da ~^ (d ~& b) ~^ ab
             ch = (h ~& e) ~^ ((lognot h) ~& f)
          in let t1 = g + s1 + ch + (get (j+1) ks) + (get (j+1) blocks)
                 t2 = s0 + maj
             in let g2 = c + t1 ~<< 0
                    c2 = t1 + t2 ~<< 0
                in let s2 =  ((c2 ~>>> 2) ~| (c2 ~<< 30))
                          ~^ ((c2 ~>>> 13) ~| (c2 ~<< 19))
                          ~^ ((c2 ~>>> 22) ~| (c2 ~<< 10))
                       s3 =  ((g2 ~>>> 6) ~| (g2 ~<< 26))
                          ~^ ((g2 ~>>> 11) ~| (g2 ~<< 21))
                          ~^ ((g2 ~>>> 25) ~| (g2 ~<< 7))
                       cd = c2 ~& d
                   in let maj = cd ~^ (c2 ~& a) ~^ da
                          ch2 = (g2 ~& h) ~^ ((lognot g2) ~& e)
                      in let t3 = f + s3 + ch2 + (get (j+2) ks) + (get (j+2) blocks)
                             t4 = s2 + maj
                         in let f2 = b + t3 ~<< 0
                                b2 = t3 + t4 ~<< 0
                            in let s4 =  ((b2 ~>>> 2) ~| (b2 ~<< 30))
                                      ~^ ((b2 ~>>> 13) ~| (b2 ~<< 19))
                                      ~^ ((b2 ~>>> 22) ~| (b2 ~<< 10))
                                   s5 =  ((f2 ~>>> 6) ~| (f2 ~<< 26))
                                      ~^ ((f2 ~>>> 11) ~| (f2 ~<< 21))
